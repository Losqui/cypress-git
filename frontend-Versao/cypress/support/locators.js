const locators = {
    MODELO: { 
        ...
        VERSAO:{
            ...
            VALIDACAOCODIGO: ':nth-child(3) > .ant-form-item-control > .ant-form-item-explain > div',
            VALIDACAODESCRICAO: ':nth-child(4) > .ant-form-item-control > .ant-form-item-explain > div',
            VALIDACAOPUBLICACAO: ':nth-child(5) > :nth-child(1) > .ant-row > .ant-form-item-control > .ant-form-item-explain > div',
            VALIDACAOSTATUS: '.ant-col-offset-2 > .ant-row > .ant-form-item-control > .ant-form-item-explain > div',
            NOMETELA: '.styles__Title-sc-12b1chh-2',
            CODIGO: '#cadastro-versao-form_codigo',
            DESCRICAO: '#cadastro-versao-form_descricao',
            STATUS: '#cadastro-versao-form_status', 
